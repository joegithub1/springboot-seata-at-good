...
public class CodeGenerator {
    ...
    @Test
    void gen(){
        String projectPath = "E:\\IdeaProjects\\springboot-seata-at-good\\good-service";
        String projectApiPath = "E:\\IdeaProjects\\springboot-seata-at-good\\good-api";
        Map<OutputFile, String> pathInfo = MapUtil.builder(new HashMap<OutputFile, String>())
                .put(OutputFile.serviceImpl,
                        projectPath +"\\src\\main\\java\\com\\joe\\good\\service\\impl")
                .put(OutputFile.controller,
                        projectPath + "\\src\\main\\java\\com\\joe\\good\\controller")
                .put(OutputFile.mapperXml, projectPath + "\\src\\main\\resources\\mapper")
                .put(OutputFile.mapper, projectPath + "\\src\\main\\java\\com\\joe\\good\\mapper")
                .build();

        FastAutoGenerator
                .create(new DataSourceConfig.Builder(
                        "jdbc:mysql://127.0.0.1:3306/seata_at_good?zeroDateTimeBehavior=convertToNull&useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&autoReconnect=true&allowMultiQueries=true",
                ...
                .globalConfig(builder -> {
                    ...
                    builder.parent("com.joe").moduleName("good").entity("entity").service("service").serviceImpl("service.impl")
                    ...
                    builder.enableCapitalMode().enableSkipView().disableSqlFilter().addInclude("t_good") // 设置需要生成的表名
